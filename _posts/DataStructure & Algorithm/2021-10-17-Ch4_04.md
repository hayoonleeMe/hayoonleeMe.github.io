---
title: "C++ Algorithm Chapter4_4 A* 길찾기 알고리즘"
excerpt: "A* 길찾기 알고리즘"
categories:
  - Cpp Algorithm
tags:
...
{
  int32 g = 0;
  int32 h = 10 * (abs(dest.y - start.y) + abs(dest.x - start.x)); // 휴리스틱은 임의로 만들어도 상관없다.
